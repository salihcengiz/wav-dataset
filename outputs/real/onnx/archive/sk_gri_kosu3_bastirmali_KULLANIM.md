# `sk_gri_kosu3_bastirmali.onnx` — Kullanım Kartı
...
oturum = ort.InferenceSession('sk_gri_kosu3_bastirmali.onnx')
...
- Spektrogram real_data ile ortusuyor: **maks 1.1e-03 dB fark**
- ONNX ciktisi PyTorch ile ortusuyor: **maks 4.3e-06 logit farki**
